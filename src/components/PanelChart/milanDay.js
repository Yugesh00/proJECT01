...
const MilanDayp = () => { 
   ...
   useEffect(() => {
    ...
    const getUser = () =>{
      ...
      const subscriber = db.collection("market_charts").doc("milanDay").collection("jodi")
...
<tbody>
   ...
   <tr>
      ...
      <td className="r"> 3<br/> 3<br/> 6<br/></td>
      <td className="r"> * <br/> * <br/> * <br/></td>
      <td className="r">**</td>
      <td className="r"> *<br/> *<br/> *<br/></td>
      <td className="r"> * <br/> * <br/> * <br/></td>
   ...
   <tr>
      ...
      <td className="r"> 1 <br/> 1 <br/> 0 <br/></td>
