...
const MainBazarj = () => { 
   ...
   useEffect(() => {
    ...
    const getUser = () =>{
      ...
      const subscriber = db.collection("market_charts").doc("mainBazar").collection("panel")
  ...
  return (
   ...
   <tbody>
      ...
      <tr>
         <td  className="chart-69">70</td>
         <td  className="chart-69">20</td>
         <td  className="chart-69">39</td>
         <td  className="chart-00">50</td>
